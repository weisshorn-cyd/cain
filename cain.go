...
type envConfig struct {
	...
	LogLevel    *slog.LevelVar `default:"debug" desc:"The level to log at"    envconfig:"LOG_LEVEL"`
	...
	MetadataDomain string `default:"cyd.ch" desc:"The domain of the labels and annotations, this can allow multiple instances of the injector" envconfig:"METADATA_DOMAIN"`
	...
	RedHatInitImage string `default:"cain-redhat-init"                                                  desc:"The container image to use for the RedHat family init containers" envconfig:"REDHAT_INIT_IMAGE"`
	RedHatInitTag   string `desc:"The container image tag to use for the RedHat family init containers" envconfig:"REDHAT_INIT_TAG"`
	DebianInitImage string `default:"cain-debian-init"                                                  desc:"The container image to use for the Debian family init containers" envconfig:"DEBIAN_INIT_IMAGE"`
	DebianInitTag   string `desc:"The container image tag to use for the RedHat family init containers" envconfig:"DEBIAN_INIT_TAG"`

	MetricsSubsystem string `default:""         desc:"The subsystem for the metrics"               envconfig:"METRICS_SUBSYSTEM"`
	MetricsPath      string `default:"/metrics" desc:"The endpoint where metrics can be retrieved" envconfig:"METRICS_PATH"`
...
func run(env envConfig, log *slog.Logger) error { //nolint: cyclop,funlen // hard to reduce ifs that are mainly for err checking
	...
	metricsMux.Handle(env.MetricsPath, promHandler)
